...
label = ['(4*8)+8','7+3*0','5+(5+2)','(8-0)-8','0+(0+2)','(2*5)+0','0+(1+8)','2+(4+9)','7*2+4','0-(7*1)','9*(3*9)','2+8-3','(4-8)*5','6-4+4','5+(1*6)','4*(3+8)','6+(5*3)','0+(6+1)','6*(0*2)','(5*8)+4']
...
def get_next_batch(batch_size=20):
	...
	for i in range(batch_size):
		...
		batch_x[i,:] = Image_array[i].flatten()
		batch_y[i,:] = text2array(label[i])
